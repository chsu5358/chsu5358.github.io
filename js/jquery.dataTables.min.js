...
<html lang="en">
  ...
  <title>bib-publication-list/jquery.dataTables.min.js at master · vkaravir/bib-publication-list</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTkyNjgxNDkxOjYyN2M5YWQ5NDk4NDgzMDMwMWE1OTM1YWQ2ZTZhYTk1YmFjNTY0NTM0ZmYyMjY5ZjBhNjYzZDM1MTIxZTdmNDk=--5c9f02e3db03b79c01d80ed8e10e3f2bfed82248">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="DA22:248E1:35E02D4:501911D:59E42C7D" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="chsu5358">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta content="163030" name="octolytics-dimension-user_id" /><meta content="vkaravir" name="octolytics-dimension-user_login" /><meta content="550841" name="octolytics-dimension-repository_id" /><meta content="vkaravir/bib-publication-list" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="550841" name="octolytics-dimension-repository_network_root_id" /><meta content="vkaravir/bib-publication-list" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/vkaravir/bib-publication-list/blob/master/lib/jquery.dataTables.min.js" data-pjax-transient>
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/vkaravir/bib-publication-list/search" class="js-site-search-form" data-scoped-search-url="/vkaravir/bib-publication-list/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/vkaravir/bib-publication-list/blob/master/lib/jquery.dataTables.min.js" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="o1n2jECA/VocCRQu7qsmjx1hSyH/KJXKogpJ+dG6Dtu2aOrISfSQno3r8QKokQI0fE3Qr9sAoWBv2zlNHbyyOg==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="shWA2DCIW9JzAe2OJqRLCXQpedElyDcdJeFlWb5EOVmnJJycOfw2FuLjCKJgnm+yFQXiXwHgA7foMBXtckKFuA==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="t7Yh4O/fsgbwsb202h0VpK+f8fGeMnjC+YIoRKXtB1Fr2VD4sqjUblHS62RXFw91cgTb6KjrM6I5r1f/TjHJow==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="550841" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/vkaravir/bib-publication-list/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="sf/+7p9mxh8BeCCEsRBB9iqCvwi+vLAQmUc50eA3225s/UBbI6KhZQIB810hrb8FzQpI7kFpMSlK+8gH+sEyXw==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/vkaravir/bib-publication-list/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="kMh8na+xGGj40aCcNFtasALd/hxyAq8FyPwwrEpZ+sXivAQxUhWjRRGO8yHyE5vdhEWj+DbVTAsW5p9y2RpKzQ==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/vkaravir/bib-publication-list/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="YDDIDC0PSd50P/Pnd9yjEG8RqWqeD9lK0YSR3HkbUHZLxy4E2jPQvWBH5RZCw+dkPEmxICD+GeD20pjqVx46VQ==" /></div>
            <button
                type="submit"
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/vkaravir/bib-publication-list/blob/17d3122649f377fd549effc02f17ab7417bc6135/lib/jquery.dataTables.min.js" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:d27d7e76f71c2c21bf68f29ba51f35d1 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/vkaravir/bib-publication-list/blob/master/lib/jquery.dataTables.min.js"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/vkaravir/bib-publication-list/commit/38edb088599018817594692ca3a7b57310e91121" data-pjax>
          38edb08
        </a>
        <relative-time datetime="2011-05-23T14:34:18Z">May 23, 2011</relative-time>
      </span>
      <div>
        ...
        <a href="/vkaravir" class="user-mention" rel="author">vkaravir</a>
          <a href="/vkaravir/bib-publication-list/commit/38edb088599018817594692ca3a7b57310e91121" class="message" data-pjax="true" title="Added Jakefile to concat/minify the JS sources">Added Jakefile to concat/minify the JS sources</a>
      </div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/vkaravir/bib-publication-list/raw/master/lib/jquery.dataTables.min.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/vkaravir/bib-publication-list/blame/master/lib/jquery.dataTables.min.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/vkaravir/bib-publication-list/commits/master/lib/jquery.dataTables.min.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>

        <a class="btn-octicon tooltipped tooltipped-nw"
           href="x-github-client://openRepo/https://github.com/vkaravir/bib-publication-list?branch=master&amp;filepath=lib%2Fjquery.dataTables.min.js"
           aria-label="Open this file in GitHub Desktop"
           data-ga-click="Repository, open with desktop, type:mac">
            <svg aria-hidden="true" class="octicon octicon-device-desktop" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M15 2H1c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1h5.34c-.25.61-.86 1.39-2.34 2h8c-1.48-.61-2.09-1.39-2.34-2H15c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1zm0 9H1V3h14v8z"/></svg>
        </a>

        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/vkaravir/bib-publication-list/edit/master/lib/jquery.dataTables.min.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="6B+34lC9cO0GwJry11b+GdLclwXmOOtAdd8mPF8rBHTGZ+Xn7ivlpobbLLMKZLw8eYULWDoebbQ8a39gzojeXA==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/vkaravir/bib-publication-list/delete/master/lib/jquery.dataTables.min.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="JclHNSZghTCxotskdi4gOkppG59pm5Ug6pbySYaf2TBLn64ZGhiv2jXXePppD7AziGiegbBookWrsVR0ptV4zw==" /></div>
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * File:        jquery.dataTables.min.js</span></td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * Version:     1.6.2</span></td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * Author:      Allan Jardine (www.sprymedia.co.uk)</span></td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * Info:        www.datatables.net</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * Copyright 2008-2010 Allan Jardine, all rights reserved.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC9" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * This source file is free software, under either the GPL v2 license or a</span></td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * BSD style license, as supplied with this software.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC12" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * This source file is distributed in the hope that it will be useful, but </span></td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY </span></td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * or FITNESS FOR A PARTICULAR PURPOSE. See the license files for details.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC45" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">nPaging</span>.<span class="pl-c1">appendChild</span>(nPrevious);<span class="pl-smi">nPaging</span>.<span class="pl-c1">appendChild</span>(nList);<span class="pl-smi">nPaging</span>.<span class="pl-c1">appendChild</span>(nNext);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC58" class="blob-code blob-code-inner js-file-line">iEndButton<span class="pl-k">=</span>iPages}<span class="pl-k">else</span>{<span class="pl-k">if</span>(iCurrentPage<span class="pl-k">&lt;=</span>iPageCountHalf){iStartButton<span class="pl-k">=</span><span class="pl-c1">1</span>;iEndButton<span class="pl-k">=</span>iPageCount</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC64" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">oSettings</span>.<span class="pl-smi">_iDisplayStart</span><span class="pl-k">=</span>iTarget<span class="pl-k">*</span><span class="pl-smi">oSettings</span>.<span class="pl-smi">_iDisplayLength</span>;<span class="pl-en">fnCallbackDraw</span>(oSettings);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC178" class="blob-code blob-code-inner js-file-line">}}function _fnInitalise(oSettings){if(oSettings.bInitialised===false){setTimeout(function(){_fnInitalise(oSettings)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC185" class="blob-code blob-code-inner js-file-line"><span class="pl-en">_fnCalculateEnd</span>(oSettings);<span class="pl-en">_fnDraw</span>(oSettings)}<span class="pl-en">_fnProcessingDisplay</span>(oSettings,<span class="pl-c1">false</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC207" class="blob-code blob-code-inner js-file-line">}}}function _fnAddData(oSettings,aData){if(aData.length!=oSettings.aoColumns.length){alert(&quot;DataTables warning: Added data does not match known number of columns&quot;);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC217" class="blob-code blob-code-inner js-file-line"><span class="pl-k">return</span> iThisIndex}function _fnGatherData(oSettings){var iLoop,i,iLen,j,jLen,jInner,nTds,nTrs,nTd,aLocalData,iThisIndex,iRow,iRows,iColumn,iColumns;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC235" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">nCell</span>.<span class="pl-c1">parentNode</span>.<span class="pl-c1">removeChild</span>(nCell)}}}}}function _fnDrawHead(oSettings){var i,nTh,iLen;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC251" class="blob-code blob-code-inner js-file-line">iCorrector<span class="pl-k">++</span>}}}}function _fnDraw(oSettings){var i,iLen;var anRows=[];var iRowCount=0;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC260" class="blob-code blob-code-inner js-file-line"><span class="pl-k">if</span>(<span class="pl-k">!</span>nRow<span class="pl-k">&amp;&amp;!</span>bRowError){<span class="pl-en">alert</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>DataTables warning: A node was not returned by fnRowCallback<span class="pl-pds">&quot;</span></span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC273" class="blob-code blob-code-inner js-file-line">}}}function _fnReDraw(oSettings){if(oSettings.oFeatures.bSort){_fnSort(oSettings,oSettings.oPreviousSearch)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC275" class="blob-code blob-code-inner js-file-line">}<span class="pl-k">else</span>{<span class="pl-en">_fnCalculateEnd</span>(oSettings);<span class="pl-en">_fnDraw</span>(oSettings)}}}function _fnAjaxUpdate(oSettings){if(oSettings.bAjaxDataGet){_fnProcessingDisplay(oSettings,true);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC299" class="blob-code blob-code-inner js-file-line"><span class="pl-en">_fnDraw</span>(oSettings);<span class="pl-smi">oSettings</span>.<span class="pl-smi">bAjaxDataGet</span><span class="pl-k">=</span><span class="pl-c1">true</span>;<span class="pl-en">_fnProcessingDisplay</span>(oSettings,<span class="pl-c1">false</span>)</td>
      </tr>
      <tr>
        <td id="L300" class="blob-num js-line-number" data-line-number="300"></td>
        <td id="LC300" class="blob-code blob-code-inner js-file-line">}function _fnAddOptionsHtml(oSettings){var nHolding=document.createElement(&quot;div&quot;);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC318" class="blob-code blob-code-inner js-file-line">}function _fnFeatureHtmlFilter(oSettings){var nFilter=document.createElement(&quot;div&quot;);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC326" class="blob-code blob-code-inner js-file-line">}function _fnFilterComplete(oSettings,oInput,iForce){_fnFilter(oSettings,oInput.sSearch,iForce,oInput.bEscapeRegex);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC330" class="blob-code blob-code-inner js-file-line">}function _fnFilterCustom(oSettings){var afnFilters=_oExt.afnFiltering;for(var i=0,iLen=afnFilters.length;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC333" class="blob-code blob-code-inner js-file-line">iCorrector<span class="pl-k">++</span>}}}}function _fnFilterColumn(oSettings,sInput,iColumn,bEscapeRegex){if(sInput===&quot;&quot;){return</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC345" class="blob-code blob-code-inner js-file-line">}function _fnBuildSearchArray(oSettings,iMaster){oSettings.asDataSearch.splice(0,oSettings.asDataSearch.length);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC350" class="blob-code blob-code-inner js-file-line">}}}}function _fnDataToSearch(sData,sType){if(typeof _oExt.ofnSearch[sType]==&quot;function&quot;){return _oExt.ofnSearch[sType](sData)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC352" class="blob-code blob-code-inner js-file-line">}}}<span class="pl-k">return</span> sData}function _fnSort(oSettings,bApplyClasses){var aaSort=[];var oSort=_oExt.oSort;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC363" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">eval</span>(sDynamicSort);<span class="pl-smi">oSettings</span>.<span class="pl-smi">aiDisplayMaster</span>.<span class="pl-c1">sort</span>(fnLocalSorting)}<span class="pl-k">else</span>{<span class="pl-k">var</span> aAirSort<span class="pl-k">=</span>[];</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC370" class="blob-code blob-code-inner js-file-line"><span class="pl-en">_fnCalculateEnd</span>(oSettings);<span class="pl-en">_fnDraw</span>(oSettings)}}function _fnSortAttachListener(oSettings,nNode,iDataIndex,fnCallback){$(nNode).click(function(e){if(oSettings.aoColumns[iDataIndex].bSortable===false){return</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC401" class="blob-code blob-code-inner js-file-line">}<span class="pl-k">if</span>(iClass<span class="pl-k">&lt;</span><span class="pl-c1">3</span>){iClass<span class="pl-k">++</span>}}}}function _fnFeatureHtmlPaginate(oSettings){var nPaginate=document.createElement(&quot;div&quot;);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC410" class="blob-code blob-code-inner js-file-line">}function _fnFeatureHtmlInfo(oSettings){var nInfo=document.createElement(&quot;div&quot;);nInfo.className=oSettings.oClasses.sInfo;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC413" class="blob-code blob-code-inner js-file-line">}function _fnUpdateInfo(oSettings){if(!oSettings.oFeatures.bInfo||oSettings.aanFeatures.i.length===0){return</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC419" class="blob-code blob-code-inner js-file-line">i<span class="pl-k">&lt;</span>iLen;i<span class="pl-k">++</span>){n[i].<span class="pl-smi">innerHTML</span><span class="pl-k">=</span>sInfo}}}function _fnFeatureHtmlLength(oSettings){var sName=(oSettings.sTableId===&quot;&quot;)?&quot;&quot;:&#39;name=&quot;&#39;+oSettings.sTableId+&#39;_length&quot;&#39;;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC428" class="blob-code blob-code-inner js-file-line">}<span class="pl-en">_fnDraw</span>(oSettings)});<span class="pl-k">return</span> nLength}function _fnFeatureHtmlProcessing(oSettings){var nProcessing=document.createElement(&quot;div&quot;);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC432" class="blob-code blob-code-inner js-file-line">}function _fnProcessingDisplay(oSettings,bShow){if(oSettings.oFeatures.bProcessing){var an=oSettings.aanFeatures.r;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC434" class="blob-code blob-code-inner js-file-line">}}}function _fnVisibleToColumnIndex(oSettings,iMatch){var iColumn=-1;for(var i=0;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC436" class="blob-code blob-code-inner js-file-line">}<span class="pl-k">if</span>(iColumn<span class="pl-k">==</span>iMatch){<span class="pl-k">return</span> i}}<span class="pl-k">return</span> <span class="pl-c1">null</span>}function _fnColumnIndexToVisible(oSettings,iMatch){var iVisible=-1;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC439" class="blob-code blob-code-inner js-file-line">}function _fnNodeToDataIndex(s,n){for(var i=0,iLen=s.aoData.length;i&lt;iLen;i++){if(s.aoData[i]!==null&amp;&amp;s.aoData[i].nTr==n){return i</td>
      </tr>
      <tr>
        <td id="L440" class="blob-num js-line-number" data-line-number="440"></td>
        <td id="LC440" class="blob-code blob-code-inner js-file-line">}}<span class="pl-k">return</span> <span class="pl-c1">null</span>}function _fnVisbleColumns(oS){var iVis=0;for(var i=0;i&lt;oS.aoColumns.length;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC463" class="blob-code blob-code-inner js-file-line">}}function fnGetMaxLenString(oSettings,iCol){var iMax=0;var iMaxIndex=-1;for(var i=0;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC466" class="blob-code blob-code-inner js-file-line">}function _fnArrayCmp(aArray1,aArray2){if(aArray1.length!=aArray2.length){return 1</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC469" class="blob-code blob-code-inner js-file-line">}}<span class="pl-k">return</span><span class="pl-s"><span class="pl-pds">&quot;</span>string<span class="pl-pds">&quot;</span></span>}function _fnSettingsFromNode(nTable){for(var i=0;i&lt;_aoSettings.length;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC481" class="blob-code blob-code-inner js-file-line">}function _fnEscapeRegex(sVal){var acEscape=[&quot;/&quot;,&quot;.&quot;,&quot;*&quot;,&quot;+&quot;,&quot;?&quot;,&quot;|&quot;,&quot;(&quot;,&quot;)&quot;,&quot;[&quot;,&quot;]&quot;,&quot;{&quot;,&quot;}&quot;,&quot;\\&quot;,&quot;$&quot;,&quot;^&quot;];</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC483" class="blob-code blob-code-inner js-file-line">}function _fnReOrderIndex(oSettings,sColumns){var aColumns=sColumns.split(&quot;,&quot;);var aiReturn=[];</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC485" class="blob-code blob-code-inner js-file-line"><span class="pl-k">break</span>}}}<span class="pl-k">return</span> aiReturn}function _fnColumnOrdering(oSettings){var sNames=&quot;&quot;;for(var i=0,iLen=oSettings.aoColumns.length;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC487" class="blob-code blob-code-inner js-file-line">}<span class="pl-k">return</span> <span class="pl-smi">sNames</span>.<span class="pl-c1">slice</span>(<span class="pl-c1">0</span>,<span class="pl-k">-</span><span class="pl-c1">1</span>)}function _fnClearTable(oSettings){oSettings.aoData.length=0;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC489" class="blob-code blob-code-inner js-file-line">}function _fnSaveState(oSettings){if(!oSettings.oFeatures.bStateSave){return}var i;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC499" class="blob-code blob-code-inner js-file-line">}function _fnLoadState(oSettings,oInit){if(!oSettings.oFeatures.bStateSave){return</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC509" class="blob-code blob-code-inner js-file-line">}}}}function _fnCreateCookie(sName,sValue,iSecs){var date=new Date();date.setTime(date.getTime()+(iSecs*1000));</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC511" class="blob-code blob-code-inner js-file-line">}function _fnReadCookie(sName){var sNameEQ=sName+&quot;_&quot;+window.location.pathname.replace(/[\/:]/g,&quot;&quot;).toLowerCase()+&quot;=&quot;;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC514" class="blob-code blob-code-inner js-file-line">}}<span class="pl-k">return</span> <span class="pl-c1">null</span>}function _fnGetUniqueThs(nThead){var nTrs=nThead.getElementsByTagName(&quot;tr&quot;);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC526" class="blob-code blob-code-inner js-file-line">}}}<span class="pl-k">return</span> aReturn}function _fnMap(oRet,oSrc,sName,sMappedName){if(typeof sMappedName==&quot;undefined&quot;){sMappedName=sName</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC548" class="blob-code blob-code-inner js-file-line"><span class="pl-k">return</span> _aoSettings[i]}}<span class="pl-k">var</span> oSettings<span class="pl-k">=</span><span class="pl-k">new</span> <span class="pl-en">classSettings</span>();<span class="pl-smi">_aoSettings</span>.<span class="pl-c1">push</span>(oSettings);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC578" class="blob-code blob-code-inner js-file-line">}<span class="pl-smi">oCol</span>.<span class="pl-smi">bVisible</span><span class="pl-k">=</span><span class="pl-smi">oInit</span>.<span class="pl-smi">saved_aoColumns</span>[i].<span class="pl-smi">bVisible</span>}<span class="pl-en">_fnAddColumn</span>(oSettings,oCol,nTh)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC587" class="blob-code blob-code-inner js-file-line"><span class="pl-k">if</span>(bInitHandedOff<span class="pl-k">===</span><span class="pl-c1">false</span>){<span class="pl-en">_fnInitalise</span>(oSettings)}})}})(jQuery);</td>
      </tr>
</table>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a href="/vkaravir/bib-publication-list/blame/17d3122649f377fd549effc02f17ab7417bc6135/lib/jquery.dataTables.min.js" class="dropdown-item js-update-url-with-hash" id="js-view-git-blame">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2017 <span title="0.21592s from unicorn-2697601825-2d0fj">GitHub</span>, Inc.</li>
